...
| 3 | Scheduled reminder notifications | Done |
...
Spec for Phase 3: `docs/superpowers/specs/2026-07-16-mood-tracker-phase3-design.md`.
Phases 4-5 each get their own spec when reached — see `docs/requirements/README.md` for
